...
$idFiliere = (int)preg_quote($_GET['id']);
$nomFil = $databases->getAllData('SELECT * FROM filiere WHERE idFiliere='.$idFiliere);
?>
<div class="container">
    <div class="jumbotron">
        <form action="" method="post">
        <?php
        $filiere = new Input('fil','texte','form-control',$nomFil['nomFiliere'],'');
